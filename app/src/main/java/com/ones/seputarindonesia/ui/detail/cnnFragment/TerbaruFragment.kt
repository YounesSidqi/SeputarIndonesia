...
import com.ones.seputarindonesia.databinding.FragmentTerbaruCnnBinding
import com.ones.seputarindonesia.utils.NewsViewModelFactory

class TerbaruFragment : Fragment() {

    private lateinit var binding: FragmentTerbaruCnnBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentTerbaruCnnBinding.inflate(inflater, container, false)
        return binding.root
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        commonViewModel.CNNTerbaruNews.observe(viewLifecycleOwner){
                dataNews -> mAdapter.setData(dataNews.data?.articles)
            binding.rvTerbarucnnNews.apply {
                adapter = mAdapter
