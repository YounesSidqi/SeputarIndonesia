...
import com.ones.seputarindonesia.databinding.FragmentInternasionalCnnBinding
...
class InternasionalFragment : Fragment() {
    ...
    private lateinit var binding: FragmentInternasionalCnnBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentInternasionalCnnBinding.inflate(inflater, container, false)
        return binding.root
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        commonViewModel.getCNNInternasionalNews()
        commonViewModel.CNNInternasional.observe(viewLifecycleOwner){
                dataNews -> mAdapter.setData(dataNews.data?.articles)
            binding.rvInternasionalNews.apply {
                adapter = mAdapter
