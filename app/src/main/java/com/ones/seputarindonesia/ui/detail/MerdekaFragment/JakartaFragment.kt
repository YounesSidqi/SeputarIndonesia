...
class JakartaFragment : Fragment() {

    private lateinit var binding: FragmentJakartaMerdekaBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentJakartaMerdekaBinding.inflate(inflater, container, false)
        return binding.root
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        commonViewModel.getMERDEKAJakartaNews()
        commonViewModel.MERDEKAJakarta.observe(viewLifecycleOwner){
                dataNews -> mAdapter.setData(dataNews.data?.articles)
            binding.rvJakartaNews.apply {
                adapter = mAdapter
