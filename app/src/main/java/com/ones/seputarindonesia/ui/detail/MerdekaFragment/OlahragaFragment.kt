...
import com.ones.seputarindonesia.databinding.FragmentJakartaMerdekaBinding
import com.ones.seputarindonesia.databinding.FragmentNasionalCnnBinding
import com.ones.seputarindonesia.databinding.FragmentOlahragaMerdekaBinding
...
class OlahragaFragment : Fragment() {
    ...
    private lateinit var binding: FragmentOlahragaMerdekaBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentOlahragaMerdekaBinding.inflate(inflater, container, false)
        return binding.root
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        commonViewModel.getMERDEKAOlahragaNews()
        commonViewModel.MERDEKAOlahraga.observe(viewLifecycleOwner){
                dataNews -> mAdapter.setData(dataNews.data?.articles)
            binding.rvOlahragaNews.apply {
                adapter = mAdapter
