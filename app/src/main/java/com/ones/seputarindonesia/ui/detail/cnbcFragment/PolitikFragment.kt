...
class PolitikFragment : Fragment() {
    ...
    private lateinit var binding: FragmentPolitikCnbcBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentPolitikCnbcBinding.inflate(inflater, container, false)
        return binding.root
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        commonViewModel.getPolitikNews()
        commonViewModel.politikNews.observe(viewLifecycleOwner){
                dataNews -> mAdapter.setData(dataNews.data?.articles)
            binding.rvPolitikNews.apply {
                adapter = mAdapter
